...
public class CPHInline
{
    ...
    public bool Execute()
    {
		...
		int nouveauPvMax    = int.Parse(LireValeur(json, "pvMax"))     + 2;
		int nouveauPvActuel = int.Parse(LireValeur(json, "pvActuels")) + 2;
		json = ModifierValeur(json, "pvMax",     nouveauPvMax.ToString(),    false);
		json = ModifierValeur(json, "pvActuels", nouveauPvActuel.ToString(), false);
		string nomStat = "PV";
